...
const members = {
    ...
    serviceBill     :20,
    othersBill      :50,
    runningMonth    :"June 26",
    previousMonth   :"May-25", // new addDecember link https://grabify.link/P0IBKC
    upComingMonth   :"July 1,2026",
    runningMealRate :59,
...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        post_payable        :2937,
        previous_paid       :4150,
        previous_dining_cost:1525,
        payment             :{"10/06/26-DBBL":2000,"15/06/26-DBBL":1000,"18/06/26-Cash":500,"20/06/26-Cash":300,"26/06/26-DBBL":1000},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :3022,//2937
        running_paid    :4800,
        running_meal    :26,
        // method 
        preMonth,
    ...
    "01797816501":{
        ...
        post_payable        :2514,
        previous_paid       :5000,
        previous_dining_cost:2013,
        payment             :{"04/06/26-Cash":2000,"18/06/26-Cash":2000,"24/06/26-Cash":500},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :2537,//2514
        running_paid    :4500,
        running_meal    :30,
        // method calling
        preMonth,
    ...
    "01518924243":{
        ...
        payment             :{"08/06/26-Cash":5000,"18/06/26-Cash":2500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :5000,//00
        running_paid    :7500,
        running_meal    :37,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        post_payable        :9051,
        previous_paid       :8000,
        previous_dining_cost:2684,
        payment             :{"16/06/26-Cash":3500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :7245,//9050
        running_paid    :3500,
        running_meal    :54,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        payment             :{"13/06/26-Cash":4500,"24/06/26-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :3923,//4433
        running_paid    :5000,
        running_meal    :40,
        // method calling
        preMonth,
    ...
    "01953722448":{
        ...
        previous_paid       :2800,
        previous_dining_cost:0,
        payment             :{"06/06/26-Cash":1000,"08/06/26-Cash":2800,"17/06/26-Cash":1000,"21/06/26-Cash":500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :2800,
        running_paid    :5300,
        running_meal    :52,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        post_payable        :3729,
        previous_paid       :5500,
        previous_dining_cost:1719,
        payment             :{"04/06/26-Cash":2000,"12/06/26-Cash":4000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4158,//4359
        running_paid    :6000,
        running_meal    :30,
        // method calling
        preMonth,
	...
	"01639523533":{
        ...
        previous_paid       :6000,
        previous_dining_cost:1525,
        payment             :{"06/06/26-Cash":4000,"26/06/26-Cash":5000},
        // running month {"01/07/24-Cash":500}
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :3223,//3488
        running_paid    :9000,
        running_meal    :26,
        // method calling
        preMonth,
    ...
    "01818334194":{
        ...
        previous_paid       :1000,
        previous_dining_cost:0,
        payment             :{"06/06/26-Cash":2500,"13/06/26-bKash":500,"15/06/26-bKash":1000,"20/06/26-bKash":700,"29/06/26-Cash":500},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :4000,//0
        running_paid    :5200,
        running_meal    :34,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        post_payable        :2000,
        previous_paid       :4500,
        previous_dining_cost:2745,
        payment             :{"12/06/26-Cash":2500},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :245,
